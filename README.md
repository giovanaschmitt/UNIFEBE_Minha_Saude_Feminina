...
1. TECNOLOGIAS ESCOLHIDAS
   1.1 Camada de Cliente (Front-end Mobile) 
   ...
   1.2 Segmento Administrativo (Web)
   ...
   1.3 Camada de Segurança e Identidade (Cloud)
   ...
   1.4 Camada de Processamento (Backend API)
  ...
  1.5 Camada de Dados e Performance (Persistência)
  ...
  1.6 Infraestrutura e Orquestração
