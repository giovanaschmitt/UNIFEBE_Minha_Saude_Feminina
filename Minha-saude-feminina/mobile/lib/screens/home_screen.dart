...
import 'package:frontend/models/cycle_record.dart';
import 'package:frontend/services/cycle_service.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Dados mockados (mantidos para os cards que ainda não têm fonte real)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: nav.buildBottomBar(context, activeTab: 'home'),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // CARD: PRÓXIMO CICLO (dados reais, calculados a partir dos registros locais)
              _buildProximoCicloCard(context),
                  ...
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: _buildBottomCard(
                        ...
                        subtitulo: "Acompanhe seus ciclos",
                      ),
                    ),
                  ),
  ...
  Widget _buildProximoCicloCard(BuildContext context) {
    return GestureDetector(
      ...
      child: ValueListenableBuilder<List<CycleRecord>>(
        ...
        builder: (context, records, _) {
          ...
          final isOnPeriod = service.allPeriodDays.contains(
          ...
          if (!hasHistory) {
            ...
            valueWidget = const Text(
              "Toque para registrar seu primeiro ciclo",
              style: TextStyle(fontSize: 14, color: corPrimaria, fontWeight: FontWeight.w600),
            );
          } else if (isOnPeriod) {
            label = "Status";
            valueWidget = Text(
              "Você está menstruada (Dia ${service.currentCycleDay})",
              style: const TextStyle(fontSize: 15, color: corPrimaria, fontWeight: FontWeight.w700),
            );
            ...
            valueWidget = Text(
              "Ciclo com $atraso dia(s) de atraso",
              style: const TextStyle(fontSize: 15, color: corPrimaria, fontWeight: FontWeight.w700),
            );
          }
